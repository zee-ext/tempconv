...
const moveChangeButton = () => {
  const inputContainer = converter.parentElement;

  inputContainer.insertAdjacentElement('afterend', changeButton);
};
...
const buttons = [convertButton, resetButton, changeButton];
